const howToData = [
  ...
  },
  {
    ...
    steps: [
      "Use only FILTERED WATER in the water reservoir.",
      "Turn the knob and pick from the selection: Hot / Over Ice / Express Cold Brew.",
      "Press the knob to switch to size, then turn the knob to select the desired brew size.",
      "The machine will show you HOW MANY SPOONS OF COFFEE you need for your selected brew size.",
      "OPEN THE TOP LID and put a PAPER FILTER in the basket FIRST.",
      "Add ground coffee into the paper filter (use the amount shown on the screen).",
      "Close the lid and make sure the carafe is in place on the hot plate.",
  ...
  },
  {
    ...
    description: "Turn on the TV and access streaming apps.",
    steps: [
      "Make sure the TV and any power strip are switched ON.",
      "Use the TV remote and press the Power button once.",
      "If you see “No Signal,” press the Input / Source button and choose the correct HDMI input.",
      "Use the remote arrows to open the main menu or home screen.",
  ...
  },
  {
    ...
    description: "Where to put trash and recycling.",
    steps: [
